    ...
    <div className="max-w-4xl mx-auto space-y-12 py-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="space-y-6 md:col-span-1">
          <div className="p-6 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-xs space-y-6">
            ...
            <div className="space-y-4 text-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-slate-500 dark:text-slate-400 text-xs">contact@devstory.local</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-slate-500 dark:text-slate-400 text-xs">Open Source / Global</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-semibold text-slate-800 dark:text-slate-200">Repository</div>
                  <div className="text-slate-500 dark:text-slate-400 text-xs">blog-project/</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="md:col-span-2">
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-xs p-8 space-y-6">
            <h3 className="font-bold text-slate-900 dark:text-white text-lg">Send a Message</h3>
            ...
            {submitSuccess && (
              <div className="p-4 rounded-xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800 text-xs text-emerald-800 dark:text-emerald-300 flex items-start gap-3">
                <svg className="w-5 h-5 shrink-0 text-emerald-600 dark:text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
