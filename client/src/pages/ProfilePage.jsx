        ...
        <div className="px-6 sm:px-8 pb-8 pt-0 relative">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 -mt-14 sm:-mt-16 mb-6">
            ...
            <div className="relative">
              {effectiveUser?.avatar && !avatarLoadError ? (
                ...
                <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl bg-gradient-to-tr from-indigo-600 to-violet-600 border-4 border-white shadow-md flex items-center justify-center text-white text-3xl sm:text-4xl font-extrabold uppercase select-none">
            ...
            {!isEditing ? (
              <Button
                ...
                className="gap-2 self-start sm:self-end border-slate-300 hover:border-indigo-400 hover:bg-indigo-50/50 hover:text-indigo-700"
              >
              ...
              <Button
                ...
                className="self-start sm:self-end text-slate-500 hover:text-slate-800"
              >
                Cancel Editing
              </Button>
            )}
          ...
          {!isEditing ? (
            <div className="space-y-6">
              ...
              {/* Bio Section */}
              <div className="p-5 rounded-xl bg-slate-50/70 border border-slate-200/70 space-y-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
                <div className="p-4 rounded-xl border border-slate-100 bg-slate-50/50 space-y-1">
                  ...
                  <p className="text-sm font-bold text-slate-800">{formattedJoinedDate}</p>
                </div>
            ...
            <form onSubmit={handleProfileSubmit} className="space-y-6 pt-2">
              ...
              <div className="flex flex-col space-y-1.5">
                <div className="flex items-center justify-between">
                  <label htmlFor="bio" className="text-xs font-semibold uppercase tracking-wider text-slate-700">
                    Bio (Max 250 characters)
                  </label>
                  <span className={`text-xs font-mono font-medium ${formData.bio.length > 250 ? "text-rose-600 font-bold" : "text-slate-400"}`}>
                ...
                />
                {formErrors.bio && (
                  <p className="text-xs text-rose-600 font-medium">{formErrors.bio}</p>
                )}
              </div>
