          ...
          return (
            <li key={item}>
              <button
                ...
                className={`min-w-9 h-9 px-2 rounded-xl text-xs sm:text-sm font-bold transition-all flex items-center justify-center cursor-pointer ${
                  isActive
