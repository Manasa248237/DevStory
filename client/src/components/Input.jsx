    ...
    <div className={`flex flex-col space-y-1.5 ${className}`}>
      ...
      <div className="relative">
        <input
          ...
          className={`w-full px-3.5 py-2.5 rounded-lg border text-sm text-slate-900 bg-white placeholder:text-slate-400 transition-all focus:outline-hidden disabled:bg-slate-100 disabled:text-slate-400 disabled:cursor-not-allowed ${
            error
      ...
      {error ? (
        <p id={`${inputId}-error`} className="text-xs text-rose-600 font-medium flex items-center gap-1 mt-1">
